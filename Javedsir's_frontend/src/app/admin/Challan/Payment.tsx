    ...
    <div className="relative flex h-full min-h-[50vh] flex-col lg:col-span-2">
      <fieldset className="grid gap-6 rounded-lg border p-6 bg-white shadow-md">
        ...
        {outputData.map((entry, index) => (
          ...
          {/* <div>
            <div className="text-gray-500 text-sm text-lg">Vehicle no.</div>
            <div className="text-lg font-semibold text-gray-900 text-sm  text-lg">{entry.vehicleNo}</div>
          </div> */}
          {/* <div>
            <div className="text-gray-500 text-sm">Phone no.</div>
            <div className="text-lg font-semibold text-gray-900 text-sm">{outputData.phoneNo}</div>
          </div> */}
          <div>
          ...
          <div>
            <div className="text-gray-500 text-sm">Name of Voilator:</div>
        ...
        <div className="flex gap-3 mt-4">
          <Button onClick={()=>handlePayment(parseInt(outputData[0].fine_imposed) +118)} className="flex items-center bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700">
            Pay Challan {parseInt(outputData[0].fine_imposed) +118} ₹
          </Button>
